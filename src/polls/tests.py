...
class QuestionIndexViewTests(TestCase):
    ...
    def test_past_question(self):
        """Questions with pub_date in the past are displayed on the index."""
    ...
    def test_future_question(self):
        """Questions with pub_date in future aren't displayed on the index."""
...
class QuestionDetailViewTests(TestCase):
    def test_future_question(self):
        """Detail view of questions with pub_date in future return HTTPS404."""
